...
`react-native-share` export a `enum` containing all supported apps, which can be seen [here](https://github.com/react-native-community/react-native-share/blob/5299d95aab25bfba6815e0f5455876897ed8ddc6/index.js#L207-L219).
...
Use this properties to customize the instagram story view. 
